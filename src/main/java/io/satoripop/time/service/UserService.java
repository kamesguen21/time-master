...
import io.satoripop.time.domain.Authority;
...
public class UserService {
    ...
    @Transactional(readOnly = true)
    public Optional<User> findOneWithAuthoritiesById(Long login) {
        return userRepository.findOneWithAuthoritiesById(login);
    }
